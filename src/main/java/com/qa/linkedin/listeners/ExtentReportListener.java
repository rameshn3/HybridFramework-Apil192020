...
import com.qa.linkedin.util.ExtentManager;
...
public class ExtentReportListener extends TestBase implements ITestListener, ISuiteListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			testReport.get().fail("<b>" + "<font color=" + "red>" +methodName+ "Screenshot of failure" + "</font>" + "</b>",
					MediaEntityBuilder.createScreenCaptureFromPath(TestUtil.screenshotName).build());
		} catch (IOException e) {

		}

		String failureLogg = "TEST CASE FAILED:"+methodName;
